    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Send one message to many X users — from a manual list or synced followers. Follower
          campaigns auto-start after sync. Sends respect your schedule and are spread across
          connected accounts.
        </p>
      </div>
